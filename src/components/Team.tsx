...
const team: TeamMember[] = [
  { name: "XPO", role: "FOUNDER & CREATIVE DIRECTOR", img: "/team/xpo.png" },
  { name: "SKETCHER", role: "CO-FOUNDER & ARTIST", img: "/team/sketcher.jpg" },
  { name: "CHUKWUFUMNANYA", role: "CO-FOUNDER & CMO", img: "/team/chukwu.png" },
  { name: "SRABON", role: "COLLAB MANAGER", img: "/team/srabon.jpg" },
  { name: "ACE", role: "MODERATOR", img: "/team/ace.jpg" },
  { name: "OSI", role: "MODERATOR", img: "/team/osi.png" },
];

const MeetTheTeam: React.FC = () => {
  // Animation variants inside component (avoids Next.js issues)
  const fadeUp = {

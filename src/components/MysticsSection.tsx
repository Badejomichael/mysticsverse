...
const BentoCard = ({
  ...
  return (
    <div className={`relative overflow-hidden rounded-3xl ${className} group`}>
      {children}
    </div>
  );
};
        ...
        ">
          <div className="flex flex-col space-y-10 md:space-y-15 z-10 max-w-lg text-left">
            ...
            <p className="text-gray-400 text-sm md:text-base">
              Welcome to Mysticsverse, where elemental <br/> beings awaken and worlds evolve.
            </p>
          </div>

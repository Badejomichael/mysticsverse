...
const FutureGlimpse = () => {
  return (
    ...
    >
      ...
      {/* Image */}
      <motion.div
        className="relative overflow-hidden rounded-xl shadow-sm w-full max-w-[3000px] h-auto"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, ease: "easeOut" }}
        viewport={{ once: true, amount: 0.3 }}
      ...
      {/* Description */}
      <motion.p
        className="max-w-2xl leading-relaxed mb-8 md:text-lg mt-7 px-6 text-left"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, ease: "easeOut" }}
        viewport={{ once: true, amount: 0.3 }}

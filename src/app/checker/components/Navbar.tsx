  ...
  return (
    <ConnectButton.Custom>
      {({
        ...
        const buttonText = connected ? formatAddress(account.address) : "CONNECT WALLET";
        const buttonAction = connected ? openAccountModal : openConnectModal;
    ...
    <>
      ...
      <nav
        className={`fixed left-0 w-full z-50 flex items-center justify-between transition-all duration-300
            ${scrolled 
            ? "top-0 backdrop-blur-sm bg-black/40" 
